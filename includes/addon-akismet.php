...
/**
 * Scan doc content using Akismet when Akismet is available.
 *
 * @since 2.0.0
 */
class BP_Docs_Akismet {
	...
	public function send_akismet_request( $package, $check = 'check', $spam = 'spam' ) {
		...
		$ignore = array(
			'HTTP_COOKIE', 'HTTP_COOKIE2', 'HTTP_X_FORWARDED_FOR', 'HTTP_X_FORWARDED_HOST', 'HTTP_MAX_FORWARDS', 'HTTP_X_FORWARDED_SERVER', 'REDIRECT_STATUS', 'SERVER_PORT', 'PATH', 'PHP_AUTH_PW', 'DOCUMENT_ROOT', 'SERVER_ADMIN', 'QUERY_STRING', 'PHP_SELF', 'argv', 'argc', 'SCRIPT_FILENAME', 'SCRIPT_NAME'
		);
